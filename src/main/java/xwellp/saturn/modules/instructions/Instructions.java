...
import xwellp.saturn.utils.InstructionUtils;
import xwellp.saturn.utils.SaturnUtils;
import xwellp.saturn.utils.config.SaturnConfigManager;
...
import static xwellp.saturn.Saturn.*;
...
public class Instructions extends Module {
    ...
    public Instructions() {
        super(Saturn.CATEGORY, "instructions", "Runs commands with different delays and number of cycles. Supports Starscript.");
    }
    ...
    private void fillWidget(GuiTheme theme, WVerticalList list) {
        ...
        SaturnConfigManager.configManager(theme, list, this);
    }
