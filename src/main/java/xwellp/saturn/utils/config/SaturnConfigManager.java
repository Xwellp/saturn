package xwellp.saturn.utils.config;
...
import static xwellp.saturn.Saturn.MOD_ID;
import static xwellp.saturn.utils.SaturnUtils.removeInvalidChars;

public class SaturnConfigManager {
    /**
